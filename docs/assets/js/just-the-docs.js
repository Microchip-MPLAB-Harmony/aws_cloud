var myVariable = `
{
  ...
  ,"7": {
    "title": "",
    "content": ". Microchip MPLAB® Harmony 3 Release Notes . AWS Cloud Release Notes v3.1.0 . New Features . Supports ECC608 Integeration with Amazon FreeRTOS and Wi-Fi Support (WINC1500/WINC3400) for SAM D/E MCUs. | Updated version of Amazon FreeRTOS 202002.00 to add support for following SAM S70, SAM E70, SAM V70/V71, SAME5x, SAMD5x, PIC32MZ EF families of 32-bit microcontrollers to securely connect to the AWS Cloud. . | Development kit and demo application support - The following table provides number of demo application available for different development kits . Development kits Applications . SAM E70 Xplained Ultra Evaluation Kit | 1 | . SAM E54 Xplained Pro Evaluation Kit | 1 | . Curiosity PIC32MZ EF 2.0 Development Board | 1 | . | . Known Issues . Same as 3.0.0 | . Development Tools . MPLAB® X IDE v5.4 | MPLAB® XC32 C/C++ Compiler v2.41 | MPLAB® X IDE plug-ins: MPLAB® Harmony Configurator (MHC) v3.4.1 and above. | . | . Dependent Components . CSP v3.7.1 | CORE v3.7.2 | BSP v3.7.0 | DEV_PACKS v3.7.0 | NET v3.6.1 | Updated version of Amazon FreeRTOS 202002.00 for Microchip Products | MHC v3.4.1 | . Microchip MPLAB® Harmony 3 Release Notes . AWS Cloud Release Notes v3.0.0 . New Features . Updated version of Amazon FreeRTOS 201908.00 to add support for SAM S70, SAM E70, SAM V70/V71, SAME5x, SAMD5x, PIC32MZ EF families of 32-bit microcontrollers to securely connect to the AWS Cloud . | Development kit and demo application support - The following table provides number of demo application available for different development kits . Development kits Applications . SAM E70 Xplained Ultra Evaluation Kit | 1 | . SAM E54 Xplained Pro Evaluation Kit | 1 | . Curiosity PIC32MZ EF 2.0 Development Board | 1 | . | . Known Issues . PIC32MZ Ethernet MAC driver does not provide configuration option to configure Unicast Hash and Multicast Hash filter. It must be enabled manually by changing the configuration macro to connect to AWS cloud. | . Development Tools . MPLAB® X IDE v5.30 | MPLAB® XC32 C/C++ Compiler v2.30 | MPLAB® X IDE plug-ins: MPLAB® Harmony Configurator (MHC) v3.3.5 and above. | . | . Dependent Components . CSP v3.6.0 | CORE v3.6.0 | BSP v3.6.0 | DEV_PACKS v3.6.0 | NET v3.5.1 | Updated version of Amazon FreeRTOS 201908.00 for Microchip Products | MHC v3.3.5 | .",
    "url": "http://localhost:4000/aws_cloud/release_notes.html",
    "relUrl": "/release_notes.html"
  }
  ,"8": {
    "title": "AWS Cloud Component and Applications",
    "content": ". MPLAB® Harmony 3 Configurations and Applications to securely connect IoT devices to the AWS cloud using Amazon FreeRTOS. . MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. . Microchip 32-bit MCUs | Microchip 32-bit MPUs | Microchip MPLAB X IDE | Microchip MPLAB® Harmony | Microchip MPLAB® Harmony Pages | . This repository contains the MPLAB® Harmony 3 AWS Cloud application examples . Release Notes | MPLAB® Harmony License | . Contents Summary . Folder Description . apps | Example applications for Amazon FreeRTOS | . config | Amazon FreeRTOS module configuration scripts | . doc | Images for Amazon FreeRTOS Component documentation | . docs | Amazon FreeRTOS help documentation | . templates | Configurations file templates | . Cloning AWS_Cloud repo . To clone or download the repo from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . This repo contains scripts needed to represent amazon-freertos as Harmony 3 component. It requires amazon-freertos repository to be cloned for code generation. . Cloning FreeRTOS (amazon-freertos) . This repo uses Git Submodules to bring in dependent components. . Note: If you download the ZIP file provided by GitHub UI or using content-manager, you will not get the contents of the submodules. (The ZIP file is also not a valid git repository) . To clone: . git clone https://github.com/MicrochipTech/amazon-freertos --recurse-submodules . If you have downloaded the repo without using the --recurse-submodules argument, you need to run: . git submodule update --init --recursive . Getting Started . For more information on FreeRTOS, refer to the Getting Started guide of different boards. . Contents Summary . Folder Description . apps | Example applications for Amazon FreeRTOS | . config | Amazon FreeRTOS module configuration scripts | . doc | Images for Amazon FreeRTOS Component documentation | . docs | Amazon FreeRTOS help documentation | . templates | Configurations file templates | . Introduction . The Amazon FreeRTOS is abstracted as Harmony 3 component to easily configure and generate code to develop cloud connected applications using Harmony 3 framework. It uses updated version of Amazon FreeRTOS 202002.00 to support Microchip products for code generation. . Amazon FreeRTOS is now termed as FreeRTOS, but we still use the term Amazon FreeRTOS as the H3 component name to avoid confusion with existing H3 FreeRTOS (kernel) Component. . The Amazon FreeRTOS is supported in the following products. . SAM E70/S70/V70/V71 Family + ECC608 (Optional) | SAM D5x/E5x Family + ECC608 (Optional) + WINC1500/WINC3400 (Optional) | PIC32MZ Embedded Connectivity with Floating Point Unit (EF) Family + ECC608 (Optional) | . This repository contains following three components for configuration and code generation. . ##AmazonFreeRTOS Component Amazon FreeRTOS component is used to configure and generate Amazon FreeRTOS code, indepdent of any hardware configuration . . ##AmazonHWInterface component The Hardware interface components is used for device specific (E5x/D5x/E70/S70/V70/V71/PIC32MZEF) and Hardware specific (Ethernet/WIFI, NVM/ECC608) configuration and harcode generation. . . There are three configurations supported by this component . Wired Solution Only. | . This solution is available in all platforms. . Wired + ECC608 Solution | . This solution is available in all platforms. . WIFI Solution (WINC based solution can be WINC1500/WINC3400) | . This solution is available in SAMD5x/E5x platform only. . #AmazonDeviceTester component Amazon DeviceTester component is used to configure and generate code for qualification testing. It adds required dependencies for testing the Amazon FreeRTOS solution using Amazon IDT (refer: https://docs.aws.amazon.com/freertos/latest/userguide/device-tester-for-freertos-ug.html). . . Important Licensing Information: For Amazon-FreeRTOS License, please refer to the license file under the amazon-freertos folder. . AWS Cloud Examples . The following applications are provided to demonstrate the AWS Cloud H3 Component . Name Description . LED Shadow Client | This example application shows how to use the Shadow client feature to set/clear device status using LED(s) using ECC608 | . . . . . .",
